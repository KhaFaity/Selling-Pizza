...
import com.pizza.security.JwtAuthenticationEntryPoint;
import com.pizza.security.JwtAuthenticationFilter;
import com.pizza.service.impl.CustomUserDetailsServiceImpl;
...
public class SecutiryConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.cors().and().csrf().disable()
				...
				.antMatchers(HttpMethod.DELETE, "/api/carts/**").permitAll()
