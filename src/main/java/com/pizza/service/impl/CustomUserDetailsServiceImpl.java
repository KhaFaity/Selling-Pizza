...
public class CustomUserDetailsServiceImpl implements UserDetailsService, CustomUserDetailsService {
	...
	public UserDetails loadUserByUsername(String usernameOrEmail) {
		HttpHeaders headers = new HttpHeaders();
	      ...
	      UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl("http://localhost:8081/api/users/findByUsernameOrEmail")
	...
	public UserDetails loadUserById(Long id) {
		HttpHeaders headers = new HttpHeaders();
	      ...
	      headers.add("Authorization","Bearer " +jwtTokenProvider.getToken());
	      HttpEntity entity = new HttpEntity(headers);
	      UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl("http://localhost:8081/api/users/loadUserById")
	    	        .queryParam("id", id);
